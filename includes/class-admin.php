...
class SCWC_Admin {
    ...
    public function render_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e('SupaChat', 'supa-chat-woocommerce'); ?></h1>
            ...
            <div id="scwc-loading" style="display: none;">
                ...
                <p><?php esc_html_e('Loading...', 'supa-chat-woocommerce'); ?></p>
            </div>
        </div>
        <?php
    }
    ...
    private function render_login_form() {
        ?>
        <div class="scwc-card">
            <h2><?php esc_html_e('Connect to SupaChat', 'supa-chat-woocommerce'); ?></h2>
            <p><?php esc_html_e('Login to your SupaChat account to start integrating your site with AI chatbots.', 'supa-chat-woocommerce'); ?></p>
            ...
            <div class="scwc-login-options">
                <div class="scwc-google-login" style="margin-bottom: 20px; text-align: center;">
                    <button type="button" id="scwc-google-login" class="button button-primary button-large" style="padding: 10px 20px; font-size: 16px;">
                        ...
                        <?php esc_html_e('Sign in with Google', 'supa-chat-woocommerce'); ?>
                    </button>
                    <p class="description" style="margin-top: 8px; font-size: 12px; color: #666;">
                        <?php esc_html_e('You will be able to choose which Google account to use', 'supa-chat-woocommerce'); ?>
                    </p>
                </div>
                ...
                <div class="scwc-divider" style="text-align: center; margin: 20px 0; position: relative;">
                    ...
                    <span style="background: white; padding: 0 15px; color: #666; position: absolute; top: -10px; left: 50%; transform: translateX(-50%);">
                        <?php esc_html_e('or', 'supa-chat-woocommerce'); ?>
                    </span>
                </div>
                
                <div class="scwc-email-login">
                    <h3 style="margin-bottom: 15px;"><?php esc_html_e('Sign in with Email & Password', 'supa-chat-woocommerce'); ?></h3>
                    <form id="scwc-login-form" method="post">
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <label for="scwc-email"><?php esc_html_e('Email', 'supa-chat-woocommerce'); ?></label>
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th scope="row">
                                        <label for="scwc-password"><?php esc_html_e('Password', 'supa-chat-woocommerce'); ?></label>
                                    </th>
                                    <td>
                        ...
                        <p class="submit">
                            <button type="submit" class="button button-secondary">
                                <?php esc_html_e('Connect to SupaChat', 'supa-chat-woocommerce'); ?>
                            </button>
                        </p>
                    </form>
                </div>
            ...
            <div class="scwc-help">
                <h3><?php esc_html_e('Need a SupaChat Account?', 'supa-chat-woocommerce'); ?></h3>
                <p><?php esc_html_e('Sign up for a free SupaChat account to get started with AI-powered customer support.', 'supa-chat-woocommerce'); ?></p>
                <a href="https://supa-chat-woocommerce.com/signup" target="_blank" class="button">
                    <?php esc_html_e('Sign Up for SupaChat', 'supa-chat-woocommerce'); ?>
                </a>
            </div>
        </div>
        <?php
            ...
            <div class="scwc-header">
                <div class="scwc-user-info">
                    <h2><?php 
                        ...
                        printf(esc_html__('Welcome, %s!', 'supa-chat-woocommerce'), esc_html($user_data['name'] ?? $user_data['email'] ?? 'User')); ?></h2>
                    <p><?php esc_html_e('Manage your chatbot integrations', 'supa-chat-woocommerce'); ?></p>
                </div>
                <div class="scwc-actions">
                    <span class="scwc-user-email">
                        <?php 
                        // translators: %s is the user's email address
                        printf(esc_html__('Logged in as: %s', 'supa-chat-woocommerce'), '<strong>' . esc_html($user_data['email'] ?? 'Unknown') . '</strong>'); ?>
                    </span>
                    <button id="scwc-logout" class="button" style="margin-left: 15px;">
                        <?php esc_html_e('Logout', 'supa-chat-woocommerce'); ?>
                    </button>
                </div>
            </div>
    ...
    private function render_integrations_content() {
        ...
        <div class="scwc-integrations">
            ...
            <div class="scwc-chatbot-selection">
                <h4><?php esc_html_e('Select Chatbot to Connect', 'supa-chat-woocommerce'); ?></h4>
                <div id="scwc-chatbots-container">
                    <div class="scwc-loading-chatbots">
                        <div class="scwc-loading-spinner"></div>
                        <p><?php esc_html_e('Loading your chatbots...', 'supa-chat-woocommerce'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div id="scwc-integration-form-container" style="display: none;">
                <div class="scwc-integration-header">
                    <h3><?php esc_html_e('Connect Your Chatbot', 'supa-chat-woocommerce'); ?></h3>
                    <p><?php esc_html_e('Enable AI-powered customer support with access to your site information.', 'supa-chat-woocommerce'); ?></p>
                </div>
                ...
                <div class="scwc-selected-chatbot-info">
                    <div class="scwc-chatbot-preview">
                        ...
                        <div class="scwc-chatbot-details">
                            <h4 id="selected-chatbot-name"><?php esc_html_e('Loading chatbot...', 'supa-chat-woocommerce'); ?></h4>
                            <p id="selected-chatbot-description" class="description"><?php esc_html_e('Loading description...', 'supa-chat-woocommerce'); ?></p>
                ...
                <div class="scwc-integration-benefits">
                    <h4><?php esc_html_e('What this connection will enable:', 'supa-chat-woocommerce'); ?></h4>
                    <div class="scwc-benefits-grid">
                        <div class="scwc-benefit-item">
                            <span class="scwc-benefit-icon">🛍️</span>
                            <div>
                                <strong><?php esc_html_e('Product Knowledge', 'supa-chat-woocommerce'); ?></strong>
                                <p><?php esc_html_e('Your chatbot will know all about your products, prices, and inventory', 'supa-chat-woocommerce'); ?></p>
                            </div>
                        </div>
                        <div class="scwc-benefit-item">
                            <span class="scwc-benefit-icon">🔒</span>
                            <div>
                                <strong><?php esc_html_e('Secure & Safe', 'supa-chat-woocommerce'); ?></strong>
                                <p><?php esc_html_e('Read-only access keeps your data secure and unchanged', 'supa-chat-woocommerce'); ?></p>
                            </div>
                        </div>
                        <div class="scwc-benefit-item">
                            <span class="scwc-benefit-icon">⚡</span>
                            <div>
                                <strong><?php esc_html_e('Instant Setup', 'supa-chat-woocommerce'); ?></strong>
                                <p><?php esc_html_e('Automatic API key generation - no technical setup required', 'supa-chat-woocommerce'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="scwc-integration-form">
                    ...
                    <div class="scwc-form-actions">
                        <button type="submit" class="button button-primary button-hero">
                            ...
                            <?php esc_html_e('Connect Chatbot', 'supa-chat-woocommerce'); ?>
                        </button>
                        <button type="button" id="scwc-cancel-integration" class="button button-large">
                            <?php esc_html_e('← Back to Chatbots', 'supa-chat-woocommerce'); ?>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div id="scwc-integration-status" style="display: none;">
                <div class="scwc-success-box">
                    <h4><?php esc_html_e('Integration Active', 'supa-chat-woocommerce'); ?></h4>
                    ...
                    <div class="scwc-integration-actions">
                        <button type="button" id="scwc-remove-integration" class="button button-secondary">
                            <?php esc_html_e('Remove Integration', 'supa-chat-woocommerce'); ?>
                        </button>
                    </div>
                </div>
            </div>
